    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.GET, "/jobs", "/api/jobs").hasAnyRole("JOB_APPLICANT", "RECRUITER")
                    .requestMatchers("/jobseeker/**", "/api/jobseeker/**").hasRole("JOB_APPLICANT")
                    .requestMatchers(HttpMethod.POST, "/job/apply", "/api/job/apply").hasRole("JOB_APPLICANT")
                    .requestMatchers(HttpMethod.GET, "/resume/**", "/api/resume/**").hasAnyRole("RECRUITER", "JOB_APPLICANT", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "/jobseeker/resume", "/api/jobseeker/resume").hasRole("JOB_APPLICANT")
